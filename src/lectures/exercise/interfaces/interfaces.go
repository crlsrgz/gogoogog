...
func (m Motorcycle) String() string {
	return fmt.Sprintf("Motorcycle: %v", string(m))// without the string() method
}
func (c Car) String() string {
	return fmt.Sprintf("Car: %v", string(c))// without the string() method
}
func (t Truck) String() string {
	return fmt.Sprintf("Truck: %v", string(t))// without the string() method
}
